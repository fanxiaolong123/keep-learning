...
- When a source file says to load Step 1 or Step 2, read `references/metalearn-map.md`. For Step 3, read `references/metalearn-study.md`. For Step 4, read `references/metalearn-step4.md`.
